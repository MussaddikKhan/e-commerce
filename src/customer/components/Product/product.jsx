...
const sortOptions = [
    ...
    { name : 'Price : Hight to Low' , href :'#' , current : false},
]
...
export default function Product() {
  ...
  function handleFilter(value, sectionId) {
        ...
        // it's check value is already present and duplicate eg : color :white and again click for white
